...
/*
 * MyStack<T> is a stack ADT implemented with a single-linked list.
 * Any changes made to the stack are made through the variable topOfStack
 * This allows for each operation to execute in constant time
 */
...
public class MyStack<T>
{
	...
	/* Places the given element onto the top of the stack
